...
<section class="aw-hero">
	<div class="aw-hero-bg">
		<img src="<?php echo esc_url( $img . '/hero.png' ); ?>" alt="<?php esc_attr_e( 'Aranjament elegant de masă pentru eveniment', 'artwave' ); ?>">
	</div>
	...
	<div class="aw-container">
		...
		<div class="aw-features">
			<div class="aw-feature">
				...
				<p><?php esc_html_e( 'Rezervăm hoteluri, pensiuni și resorturi atent selectate.', 'artwave' ); ?></p>
			</div>
